...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreUI",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreUI-1.0.0-beta.20230704132152.xcframework.zip",
			checksum: "13a18ec57a68387ceb88d3862acfcaa8d26066176d9b19e534cbc8fbd647d4ab"
		)
	]
)